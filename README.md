...
### Version 3.0.0-beta.4 for Windows x64 and MacOS (v15.6+) Apple Silicon (ARM64) are available
### See [Release.md](Release.md) for what has changed in the 3.0.0 betas, including the experimental 3D ("volumetric") marker tracker and how to enable its diagnostics when reporting a tracking problem
...
### Instructions on how to build the source code can be found in [BUILD.md](BUILD.md)
