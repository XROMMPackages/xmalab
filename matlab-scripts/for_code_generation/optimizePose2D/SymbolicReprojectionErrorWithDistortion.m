...
%  Reproject
p3d_proj =  (RCam * ((RBody * p3d) + tBody) + tCam);
...
f = norm([u; v] - [up ;vp],2);
matlabFunction(f,'File','projFuncWithDistortionPose.m');
ccode(f,'file','projFuncWithDistortionPose.h')

J = jacobian(f,[RxBody, RyBody, RzBody, txBody, tyBody, tzBody] );
matlabFunction(J,'File','jacFuncWithDistortionPose.m');
ccode(J,'file','jacFuncWithDistortionPose.h');