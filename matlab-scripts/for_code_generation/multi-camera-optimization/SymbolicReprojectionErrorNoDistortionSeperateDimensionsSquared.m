...
g = p2 - p3_proj(1:2)./p3_proj(3)

f = g.*g

matlabFunction(f,'File','projFuncNoDistortionSeperateDimensionsSquared.m');
ccode(f,'file','projFuncNoDistortionSeperateDimensionsSquared.h')

J = jacobian(f,[RxCam, RyCam, RzCam, txCam, tyCam, tzCam, fx, fy, cx, cy, RxChess, RyChess, RzChess, txChess, tyChess, tzChess] )
matlabFunction(J,'File','jacFuncNoDistortionSeperateDimensionsSquared.m');
ccode(J,'file','jacFuncNoDistortionSeperateDimensionsSquared.h')