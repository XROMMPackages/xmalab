...
f = p2 - p3_proj(1:2)./p3_proj(3)
matlabFunction(f,'File','projFuncNoDistortionSeperateDimensions.m');
ccode(f,'file','projFuncNoDistortionSeperateDimensions.h')

J = jacobian(f,[RxCam, RyCam, RzCam, txCam, tyCam, tzCam, fx, fy, cx, cy, RxChess, RyChess, RzChess, txChess, tyChess, tzChess] )
matlabFunction(J,'File','jacFuncNoDistortionSeperateDimensions.m');
ccode(J,'file','jacFuncNoDistortionSeperateDimensions.h')