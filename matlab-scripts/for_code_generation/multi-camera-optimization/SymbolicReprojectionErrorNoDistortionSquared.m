...
f = g(1) * g(1) + g(2)*g(2)
matlabFunction(f,'File','projFuncNoDistortionSquared.m');
ccode(f,'file','projFuncNoDistortionSquared.h')

J = jacobian(f,[RxCam, RyCam, RzCam, txCam, tyCam, tzCam, fx, fy, cx, cy, RxChess, RyChess, RzChess, txChess, tyChess, tzChess] )
matlabFunction(J,'File','jacFuncNoDistortionSquared.m');
ccode(J,'file','jacFuncNoDistortionSquared.h')